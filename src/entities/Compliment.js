...
var Compliment = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.JoinColumn({ name: "user_sender" }) // Passa-se o nome da foreign key
        ,
        typeorm_1.ManyToOne(function () { return User_1.User; }) // Tipo de relacionamento
        ,
    ...
    __decorate([
        ...
        typeorm_1.ManyToOne(function () { return Tag_1.Tag; }) // Relacionamento entre elogios e tags do tipo "muitos para um"
        ,
